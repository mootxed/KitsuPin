...
export interface ClipSummary { id:string; preview:string; contentLength:number; contentType:ContentType; domain:string|null; pageTitle:string|null; createdAt:number; lastCopiedAt:number; copyCount:number; pinned:boolean; categories:Category[] }
